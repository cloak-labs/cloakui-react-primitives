 ...
 */
export declare const parseHtml: (html: string | ReactNode, options?: HTMLReactParserOptions) => string | number | boolean | JSX.Element | Iterable<ReactNode> | JSX.Element[];
/**
 ...
 */
export declare const isTag: (domNode: DOMNode, tagName: HTMLTagNames) => domNode is Element;
